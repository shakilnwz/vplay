...
<template>
    <div v-if="currentVideo" class="bg-black/40 backdrop-blur-sm p-2 space-y-2 m-4 rounded-2xl border border-white/10 shadow-2xl">
        <!-- Video Title -->
        ...
        <div class="flex items-center justify-between flex-wrap gap-2 w-full">
            <div class="flex items-center gap-2 overflow-x-auto no-scrollbar w-full">
                ...
                <button
                    @click="togglePlay"
                    :class="[
                        'p-1.75 rounded-full transition-all duration-200 text-white shadow-lg flex-shrink-0',
                        isPlaying ? 'bg-blue-600 hover:bg-blue-500 shadow-blue-500/30' : 'bg-white/10 hover:bg-white/20'
                    ]"
                >
                ...
                <!-- Volume -->
                <div class="flex items-center space-x-2 bg-white/5 p-1.5 rounded-lg px-3 flex-shrink-0">
                    ...
                    <input
                        ...
                        class="w-20 h-1.5 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-blue-500 hover:accent-blue-400"
                    />
                </div>
