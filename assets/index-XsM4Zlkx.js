...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ao(e,t,n){let r=new Float32Array(qa),i=new U(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:qa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:co(),fragmentShader:`
	...
	`}function lo(e){let t=new WeakMap,n=null;function r(r){if(r&&r.isTexture){let o=r.mapping,s=o===303||o===304,c=o===301||o===302;if(s||c){let o=t.get(r),l=o===void 0?0:o.texture.pmremVersion;if(r.isRenderTargetTexture&&r.pmremVersion!==l)return n===null&&(n=new no(e)),o=s?n.fromEquirectangular(r,o):n.fromCubemap(r,o),o.texture.pmremVersion=r.pmremVersion,t.set(r,o),o.texture;if(o!==void 0)return o.texture;{let l=r.image;return s&&l&&l.height>0||c&&l&&i(l)?(n===null&&(n=new no(e)),o=s?n.fromEquirectangular(r):n.fromCubemap(r),o.texture.pmremVersion=r.pmremVersion,t.set(r,o),r.addEventListener(`dispose`,a),o.texture):null}}}return r}function i(e){let t=0;for(let n=0;n<6;n++)e[n]!==void 0&&t++;return t===6}function a(e){let n=e.target;n.removeEventListener(`dispose`,a);let r=t.get(n);r!==void 0&&(t.delete(n),r.dispose())}function o(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:o}}function uo(e){let t={};function n(n){if(t[n]!==void 0)return t[n];let r=e.getExtension(n);return t[n]=r,r}return{has:function(e){return n(e)!==null},init:function(){n(`EXT_color_buffer_float`),n(`WEBGL_clip_cull_distance`),n(`OES_texture_float_linear`),n(`EXT_color_buffer_half_float`),n(`WEBGL_multisampled_render_to_texture`),n(`WEBGL_render_shared_exponent`)},get:function(e){let t=n(e);return t===null&&vt(`WebGLRenderer: `+e+` extension not supported.`),t}}}function fo(e,t,n,r){let i={},a=new WeakMap;function o(e){let s=e.target;for(let e in s.index!==null&&t.remove(s.index),s.attributes)t.remove(s.attributes[e]);s.removeEventListener(`dispose`,o),delete i[s.id];let c=a.get(s);c&&(t.remove(c),a.delete(s)),r.releaseStatesOfGeometry(s),s.isInstancedBufferGeometry===!0&&delete s._maxInstanceCount,n.memory.geometries--}function s(e,t){return i[t.id]===!0?t:(t.addEventListener(`dispose`,o),i[t.id]=!0,n.memory.geometries++,t)}function c(n){let r=n.attributes;for(let n in r)t.update(r[n],e.ARRAY_BUFFER)}function l(e){let n=[],r=e.index,i=e.attributes.position,o=0;if(r!==null){let e=r.array;o=r.version;for(let t=0,r=e.length;t<r;t+=3){let r=e[t+0],i=e[t+1],a=e[t+2];n.push(r,i,i,a,a,r)}}else if(i!==void 0){let e=i.array;o=i.version;for(let t=0,r=e.length/3-1;t<r;t+=3){let e=t+0,r=t+1,i=t+2;n.push(e,r,r,i,i,e)}}else return;let s=new(dt(n)?Kr:Gr)(n,1);s.version=o;let c=a.get(e);c&&t.remove(c),a.set(e,s)}function u(e){let t=a.get(e);if(t){let n=e.index;n!==null&&t.version<n.version&&l(e)}else l(e);return a.get(e)}return{get:s,update:c,getWireframeAttribute:u}}function po(e,t,n){let r;function i(e){r=e}let a,o;function s(e){a=e.type,o=e.bytesPerElement}function c(t,i){e.drawElements(r,i,a,t*o),n.update(i,r,1)}function l(t,i,s){s!==0&&(e.drawElementsInstanced(r,i,a,t*o,s),n.update(i,r,s))}function u(e,i,o){if(o===0)return;t.get(`WEBGL_multi_draw`).multiDrawElementsWEBGL(r,i,0,a,e,0,o);let s=0;for(let e=0;e<o;e++)s+=i[e];n.update(s,r,1)}function d(e,i,s,c){if(s===0)return;let u=t.get(`WEBGL_multi_draw`);if(u===null)for(let t=0;t<e.length;t++)l(e[t]/o,i[t],c[t]);else{u.multiDrawElementsInstancedWEBGL(r,i,0,a,e,0,c,0,s);let t=0;for(let e=0;e<s;e++)t+=i[e]*c[e];n.update(t,r,1)}}this.setMode=i,this.setIndex=s,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function mo(e){let t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function r(t,r,i){switch(n.calls++,r){case e.TRIANGLES:n.triangles+=i*(t/3);break;case e.LINES:n.lines+=i*(t/2);break;case e.LINE_STRIP:n.lines+=i*(t-1);break;case e.LINE_LOOP:n.lines+=i*t;break;case e.POINTS:n.points+=i*t;break;default:V(`WebGLInfo: Unknown draw mode:`,r);break}}function i(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:i,update:r}}function ho(e,t,n){let r=new WeakMap,i=new fn;function a(a,o,s){let c=a.morphTargetInfluences,l=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=l===void 0?0:l.length,d=r.get(o);if(d===void 0||d.count!==u){d!==void 0&&d.texture.dispose();let e=o.morphAttributes.position!==void 0,n=o.morphAttributes.normal!==void 0,a=o.morphAttributes.color!==void 0,s=o.morphAttributes.position||[],c=o.morphAttributes.normal||[],l=o.morphAttributes.color||[],f=0;e===!0&&(f=1),n===!0&&(f=2),a===!0&&(f=3);let p=o.attributes.position.count*f,m=1;p>t.maxTextureSize&&(m=Math.ceil(p/t.maxTextureSize),p=t.maxTextureSize);let h=new Float32Array(p*m*4*u),g=new hn(h,p,m,u);g.type=re,g.needsUpdate=!0;let _=f*4;for(let t=0;t<u;t++){let r=s[t],o=c[t],u=l[t],d=p*m*4*t;for(let t=0;t<r.count;t++){let s=t*_;e===!0&&(i.fromBufferAttribute(r,t),h[d+s+0]=i.x,h[d+s+1]=i.y,h[d+s+2]=i.z,h[d+s+3]=0),n===!0&&(i.fromBufferAttribute(o,t),h[d+s+4]=i.x,h[d+s+5]=i.y,h[d+s+6]=i.z,h[d+s+7]=0),a===!0&&(i.fromBufferAttribute(u,t),h[d+s+8]=i.x,h[d+s+9]=i.y,h[d+s+10]=i.z,h[d+s+11]=u.itemSize===4?i.w:1)}}d={count:u,texture:g,size:new qt(p,m)},r.set(o,d);function v(){g.dispose(),r.delete(o),o.removeEventListener(`dispose`,v)}o.addEventListener(`dispose`,v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)s.getUniforms().setValue(e,`morphTexture`,a.morphTexture,n);else{let t=0;for(let e=0;e<c.length;e++)t+=c[e];let n=o.morphTargetsRelative?1:1-t;s.getUniforms().setValue(e,`morphTargetBaseInfluence`,n),s.getUniforms().setValue(e,`morphTargetInfluences`,c)}s.getUniforms().setValue(e,`morphTargetsTexture`,d.texture,n),s.getUniforms().setValue(e,`morphTargetsTextureSize`,d.size)}return{update:a}}function go(e,t,n,r){let i=new WeakMap;function a(a){let o=r.render.frame,c=a.geometry,l=t.get(a,c);if(i.get(l)!==o&&(t.update(l),i.set(l,o)),a.isInstancedMesh&&(a.hasEventListener(`dispose`,s)===!1&&a.addEventListener(`dispose`,s),i.get(a)!==o&&(n.update(a.instanceMatrix,e.ARRAY_BUFFER),a.instanceColor!==null&&n.update(a.instanceColor,e.ARRAY_BUFFER),i.set(a,o))),a.isSkinnedMesh){let e=a.skeleton;i.get(e)!==o&&(e.update(),i.set(e,o))}return l}function o(){i=new WeakMap}function s(e){let t=e.target;t.removeEventListener(`dispose`,s),n.remove(t.instanceMatrix),t.instanceColor!==null&&n.remove(t.instanceColor)}return{update:a,dispose:o}}var _o={1:`LINEAR_TONE_MAPPING`,2:`REINHARD_TONE_MAPPING`,3:`CINEON_TONE_MAPPING`,4:`ACES_FILMIC_TONE_MAPPING`,6:`AGX_TONE_MAPPING`,7:`NEUTRAL_TONE_MAPPING`,5:`CUSTOM_TONE_MAPPING`};function vo(e,t,n,r,i){let a=new mn(t,n,{type:e,depthBuffer:r,stencilBuffer:i}),o=new mn(t,n,{type:ie,depthBuffer:!1,stencilBuffer:!1}),s=new ti;s.setAttribute(`position`,new qr([-1,3,0,-1,-1,0,3,-1,0],3)),s.setAttribute(`uv`,new qr([0,2,0,0,2,0],2));let c=new $i({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}),[]);return(0,_.useEffect)(()=>{let e=p.current;if(!e)return;let t=new Li,n=new Oi(75,e.clientWidth/e.clientHeight,.1,1e3);n.position.set(0,0,.1);let r=new qc({antialias:!0});r.setSize(e.clientWidth,e.clientHeight),r.setPixelRatio(window.devicePixelRatio),e.appendChild(r.domElement);let i=new Qi(500,60,40);i.scale(-1,1,1);let a=new pi(i,new Br({color:0}));t.add(a),m.current=t,h.current=n,g.current=r,v.current=a;let o=e=>{x.current=requestAnimationFrame(o);let i=Math.min((e-ee.current)/1e3,.1);ee.current=e;let a=10*i;w.current.x+=(T.current.x-w.current.x)*a,w.current.y+=(T.current.y-w.current.y)*a,w.current.z+=(T.current.z-w.current.z)*a,h.current&&(h.current.rotation.y=w.current.y,h.current.rotation.x=Math.max(-Math.PI/2,Math.min(Math.PI/2,w.current.x)),h.current.rotation.z=w.current.z),r.render(t,n)};requestAnimationFrame(o);let s=()=>{let t=e.clientWidth,i=e.clientHeight;n.aspect=t/i,n.updateProjectionMatrix(),r.setSize(t,i)};return window.addEventListener(`resize`,s),()=>{window.removeEventListener(`resize`,s),x.current&&cancelAnimationFrame(x.current),e&&r.domElement&&e.removeChild(r.domElement),i.dispose(),r.dispose()}},[]),(0,_.useEffect)(()=>{let e=j.current,t=v.current;if(!e||!t)return;let i=new qi(e);i.minFilter=k,i.magFilter=k,i.format=de;let a=new wi({uniforms:{map:{value:i},isSBS:{value:n?1:0},sbsFormat:{value:r===`horizontal`?0:1},invertStereo:{value:d?1:0}},vertexShader:M.vertexShader,fragmentShader:M.fragmentShader,side:2});t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(e=>e.dispose()),t.material=a,b.current=a},[n,r,d,M]),(0,_.useEffect)(()=>{if(!v.current||!b.current)return;let e=v.current,r=b.current;e.geometry.dispose(),t===`flat`?(e.geometry=new Zi(9*(l&&u?l/u:16/9),9,1,1),e.position.set(0,0,-10),e.scale.set(1,1,1),r.uniforms.isSBS.value=0):t===`180`?(e.geometry=new Qi(500,60,40,Math.PI,Math.PI,0,Math.PI),e.position.set(0,0,0),e.scale.set(-1,1,1),r.uniforms.isSBS.value=n?1:0):(e.geometry=new Qi(500,60,40),e.position.set(0,0,0),e.scale.set(-1,1,1),r.uniforms.isSBS.value=n?1:0)},[t,n,l,u]),(0,_.useEffect)(()=>{let e=p.current;if(!e)return;let t=e=>{S.current=!0,C.current={x:e.clientX,y:e.clientY}},n=e=>{if(!S.current)return;let t=e.clientX-C.current.x,n=e.clientY-C.current.y;T.current.y+=t*.005,T.current.x+=n*.005,C.current={x:e.clientX,y:e.clientY}},r=()=>{S.current=!1},a=(e,t)=>{let n=e.clientX-t.clientX,r=e.clientY-t.clientY;return Math.sqrt(n*n+r*r)},o=(e,t)=>Math.atan2(e.clientY-t.clientY,e.clientX-t.clientX),s=e=>{e.preventDefault(),e.touches.length===1?(S.current=!0,C.current={x:e.touches[0].clientX,y:e.touches[0].clientY}):e.touches.length===2&&(S.current=!1,E.current=a(e.touches[0],e.touches[1]),D.current=o(e.touches[0],e.touches[1]),h.current&&(O.current=h.current.fov,A.current=T.current.z))},c=e=>{if(e.preventDefault(),e.touches.length===1&&S.current){let t=e.touches[0].clientX-C.current.x,n=e.touches[0].clientY-C.current.y;T.current.y+=t*.005,T.current.x+=n*.005,C.current={x:e.touches[0].clientX,y:e.touches[0].clientY}}else if(e.touches.length===2){let t=a(e.touches[0],e.touches[1]);if(E.current&&h.current){let e=E.current/t,n=Math.max(30,Math.min(110,O.current*e));h.current.fov=n,h.current.updateProjectionMatrix()}let n=o(e.touches[0],e.touches[1]);if(D.current!==null){let e=n-D.current;T.current.z=A.current+e}}},l=()=>{S.current=!1,E.current=null,D.current=null},u=e=>{if(!i)return;let t=e.alpha?Kt.degToRad(e.alpha):0,n=e.beta?Kt.degToRad(e.beta):0,r=e.gamma?Kt.degToRad(e.gamma):0,a=window.screen.orientation?Kt.degToRad(window.screen.orientation.angle):0,o=new Jt,s=new U(0,0,1),c=new er,l=new Jt,u=new Jt(-Math.sqrt(.5),0,0,Math.sqrt(.5));c.set(n,t,-r,`YXZ`),o.setFromEuler(c),o.multiply(u),o.multiply(l.setFromAxisAngle(s,-a));let d=new er().setFromQuaternion(o,`YXZ`);T.current.x=d.x,T.current.y=d.y,T.current.z=d.z};return e.addEventListener(`mousedown`,t),window.addEventListener(`mousemove`,n),window.addEventListener(`mouseup`,r),e.addEventListener(`touchstart`,s,{passive:!1}),e.addEventListener(`touchmove`,c,{passive:!1}),e.addEventListener(`touchend`,l),window.addEventListener(`deviceorientation`,u),()=>{e.removeEventListener(`mousedown`,t),window.removeEventListener(`mousemove`,n),window.removeEventListener(`mouseup`,r),e.removeEventListener(`touchstart`,s),e.removeEventListener(`touchmove`,c),e.removeEventListener(`touchend`,l),window.removeEventListener(`deviceorientation`,u)}},[i]),(0,y.jsxs)(`div`,{ref:p,className:`flex-1 bg-black relative cursor-grab active:cursor-grabbing h-full w-full overflow-hidden touch-none`,children:[(0,y.jsx)(`video`,{ref:t=>{e(t),j.current=t},src:c||void 0,className:`hidden`,playsInline:!0,crossOrigin:`anonymous`,loop:!0}),a&&(0,y.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center z-10 bg-black bg-opacity-50 pointer-events-none`,children:(0,y.jsx)(`div`,{className:`animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-blue-500`})}),o&&(0,y.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center z-20 bg-black bg-opacity-80`,children:(0,y.jsxs)(`div`,{className:`text-center p-6 max-w-md`,children:[(0,y.jsx)(`div`,{className:`text-red-500 text-5xl mb-4`,children:`⚠️`}),(0,y.jsx)(`h3`,{className:`text-xl font-bold text-white mb-2`,children:`Error Loading Video`}),(0,y.jsx)(`p`,{className:`text-gray-300 mb-6`,children:o}),(0,y.jsx)(`button`,{onClick:s,className:`px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition`,children:`Retry`})]})})]})});function Yc(){let[e,t]=(0,_.useState)([]),[n,r]=(0,_.useState)(null),[i,a]=(0,_.useState)(``),[o,s]=(0,_.useState)(!1),[c,l]=(0,_.useState)(`name`),[u,d]=(0,_.useState)(`asc`),[f,p]=(0,_.useState)(``),[m,h]=(0,_.useState)(`all`),[g,v]=(0,_.useState)(new Map),[y,b]=(0,_.useState)(!1),[x,S]=(0,_.useState)(null),C=async e=>g.get(e.name)||new Promise(t=>{let n=document.createElement(`video`);n.preload=`metadata`,n.onloadedmetadata=()=>{let r={duration:n.duration,width:n.videoWidth,height:n.videoHeight};v(t=>new Map(t.set(e.name,r))),URL.revokeObjectURL(n.src),t(r)},n.onerror=()=>{URL.revokeObjectURL(n.src),t(null)},n.src=URL.createObjectURL(e)}),w=e=>{S(null),b(!0),r(e),C(e)};return{videos:e,processedVideos:(e=>{let t=e;if(f){let e=f.toLowerCase();t=t.filter(t=>t.name.toLowerCase().includes(e))}return m!==`all`&&(t=t.filter(e=>e.name.toLowerCase().endsWith(`.${m.toLowerCase()}`))),t})((e=>[...e].sort((e,t)=>{let n=0;switch(c){case`name`:n=e.name.localeCompare(t.name);break;case`size`:n=e.size-t.size;break;case`date`:n=(e.lastModified||0)-(t.lastModified||0);break;case`duration`:{let r=g.get(e.name),i=g.get(t.name);n=(r?.duration||0)-(i?.duration||0);break}default:n=0}return u===`asc`?n:-n}))(e)),currentVideo:n,directoryPath:i,isScanning:o,sortOrder:c,sortDirection:u,filterQuery:f,filterExtension:m,videoMetadata:g,isLoadingVideo:y,error:x,setSortOrder:l,setSortDirection:d,setFilterQuery:p,setFilterExtension:h,setIsLoadingVideo:b,setError:S,handleFileSelect:async e=>{let r=Array.from(e.target.files||[]).filter(e=>e.type.startsWith(`video/`)||e.name.match(/\.(mp4|webm|ogv|mov|mkv|avi|m4v|flv|wmv)$/i));t(r),r.length>0&&!n&&w(r[0])},handleDirectoryPicker:async()=>{if(`showDirectoryPicker`in window)try{let e=await window.showDirectoryPicker();s(!0);let r=[];for await(let t of e.values())if(t.kind===`file`){let e=await t.getFile();(e.type.startsWith(`video/`)||e.name.match(/\.(mp4|webm|ogv|mov|mkv|avi|m4v|flv|wmv)$/i))&&(Object.defineProperty(e,`webkitRelativePath`,{value:e.name,writable:!1}),r.push(e))}t(r),a(e.name),r.length>0&&!n&&w(r[0])}catch(e){console.error(`Directory picker error:`,e)}finally{s(!1)}else alert(`Your browser does not support the File System Access API. Please use Chrome or Edge, or use the file input below.`)},loadVideo:w}}function Xc({onLoad:e,onError:t}={}){let[n,r]=(0,_.useState)(null),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(1),[c,l]=(0,_.useState)(0),[u,d]=(0,_.useState)(0),[f,p]=(0,_.useState)(1),m=(0,_.useCallback)(e=>{e&&r(e)},[]),h=(0,_.useCallback)(()=>{n&&(i?n.pause():n.play(),a(!i))},[i,n]);return(0,_.useEffect)(()=>{if(!n)return;let r=()=>l(n.currentTime),i=()=>{d(n.duration),e&&e()},s=()=>a(!1),c=()=>{n.error&&t&&t(n.error.message||`Video playback error`),a(!1)};return n.volume=o,n.playbackRate=f,n.addEventListener(`timeupdate`,r),n.addEventListener(`loadedmetadata`,i),n.addEventListener(`ended`,s),n.addEventListener(`error`,c),()=>{n.removeEventListener(`timeupdate`,r),n.removeEventListener(`loadedmetadata`,i),n.removeEventListener(`ended`,s),n.removeEventListener(`error`,c)}},[n,e,t]),{videoRef:m,videoElement:n,isPlaying:i,volume:o,currentTime:c,duration:u,playbackSpeed:f,togglePlay:h,handleVolumeChange:e=>{s(e),n&&(n.volume=e)},handleSeek:e=>{l(e),n&&(n.currentTime=e)},handlePlaybackSpeedChange:e=>{p(e),n&&(n.playbackRate=e)},setIsPlaying:a}}var Zc=`vr-player-settings`;function Qc(){let[e,t]=(0,_.useState)(()=>{try{let e=localStorage.getItem(Zc);if(e)return JSON.parse(e).viewMode||`180`}catch(e){console.warn(`Failed to load settings:`,e)}return`180`}),[n,r]=(0,_.useState)(()=>{try{let e=localStorage.getItem(Zc);if(e){let t=JSON.parse(e);return t.isSBS===void 0?!0:t.isSBS}}catch{}return!0}),[i,a]=(0,_.useState)(()=>{try{let e=localStorage.getItem(Zc);if(e)return JSON.parse(e).sbsFormat||`horizontal`}catch{}return`horizontal`}),[o,s]=(0,_.useState)(()=>{try{let e=localStorage.getItem(Zc);if(e)return JSON.parse(e).invertStereo||!1}catch{}return!1}),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let t={viewMode:e,isSBS:n,sbsFormat:i,invertStereo:o};try{localStorage.setItem(Zc,JSON.stringify(t))}catch(e){console.warn(`Failed to save settings:`,e)}},[e,n,i,o]),{viewMode:e,setViewMode:t,isSBS:n,setIsSBS:r,sbsFormat:i,setSbsFormat:a,invertStereo:o,setInvertStereo:s,gyroEnabled:c,enableGyro:async()=>{if(typeof DeviceOrientationEvent<`u`&&`requestPermission`in DeviceOrientationEvent)try{await DeviceOrientationEvent.requestPermission()===`granted`&&l(!0)}catch(e){console.error(`Gyroscope permission denied:`,e)}else l(!0)},orientationLocked:u,toggleOrientationLock:async()=>{if(`orientation`in screen)try{u?(await screen.orientation.unlock(),d(!1)):(await screen.orientation.lock(`landscape`),d(!0))}catch(e){console.log(`Orientation lock not supported or denied:`,e)}else alert(`Screen Orientation API is not supported in this browser.`)}}}function $c(e,t=3e3){let[n,r]=(0,_.useState)(!0),i=(0,_.useRef)(null),a=(0,_.useCallback)(()=>{r(!0),i.current&&window.clearTimeout(i.current),e&&(i.current=window.setTimeout(()=>{r(!1)},t))},[e,t]);return(0,_.useEffect)(()=>(e?a():(r(!0),i.current&&window.clearTimeout(i.current)),()=>{i.current&&window.clearTimeout(i.current)}),[e,a]),{isVisible:n,showUI:a}}function el(){let[e,t]=(0,_.useState)(!1),n=Yc(),{setIsLoadingVideo:r,setError:i}=n,a=Xc({onLoad:()=>r(!1),onError:e=>{r(!1),i(e)}}),o=Qc(),{currentVideo:s,isLoadingVideo:c,error:l,loadVideo:u,videoMetadata:d}=n,{videoRef:f,isPlaying:p}=a,{viewMode:m,isSBS:h,sbsFormat:g,gyroEnabled:v,invertStereo:C,setInvertStereo:w}=o,{isVisible:T,showUI:E}=$c(p),[D,O]=(0,_.useState)(null),[k,A]=(0,_.useState)(!1),ee=(0,_.useRef)(null);(0,_.useEffect)(()=>{if(s){let e=URL.createObjectURL(s);return O(e),()=>URL.revokeObjectURL(e)}else O(null)},[s]);let j=()=>{k||E()};return(0,y.jsxs)(`div`,{className:`flex h-screen bg-gray-900 text-white overflow-hidden`,children:[!k&&(0,y.jsx)(`button`,{onClick:()=>{t(!e),E()},className:`fixed top-4 left-4 z-50 p-2 bg-blue-600 rounded-lg lg:hidden transition-opacity duration-500 ${T||e?`opacity-100`:`opacity-0`}`,children:(0,y.jsx)(`svg`,{className:`w-6 h-6`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,children:e?(0,y.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M6 18L18 6M6 6l12 12`}):(0,y.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M4 6h16M4 12h16M4 18h16`})})}),k&&(0,y.jsx)(`button`,{onClick:()=>A(!1),className:`fixed top-4 right-4 z-50 p-3 bg-black bg-opacity-50 rounded-full border border-white/20 hover:bg-opacity-70 transition-all`,children:(0,y.jsx)(`svg`,{className:`w-6 h-6`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,children:(0,y.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:2,d:`M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z`})})}),(0,y.jsx)(b,{isOpen:e&&!k,fileHandler:n}),(0,y.jsxs)(`div`,{className:`flex-1 relative flex flex-col h-full overflow-hidden`,children:[(0,y.jsxs)(`div`,{className:`flex-1 w-full h-full relative`,onMouseMove:j,onTouchStart:j,children:[(0,y.jsx)(Jc,{ref:ee,videoRef:f,src:D,viewMode:m,isSBS:h,sbsFormat:g,invertStereo:C,gyroEnabled:v,isLoading:c,error:l,onRetry:()=>s&&u(s),width:d.get(s?.name||``)?.width,height:d.get(s?.name||``)?.height}),!s&&(0,y.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center pointer-events-none`,children:(0,y.jsxs)(`div`,{className:`text-center p-6 bg-gray-800 bg-opacity-80 rounded-lg`,children:[(0,y.jsx)(`svg`,{className:`w-24 h-24 mx-auto mb-4 text-gray-600`,fill:`currentColor`,viewBox:`0 0 20 20`,children:(0,y.jsx)(`path`,{d:`M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z`})}),(0,y.jsx)(`p`,{className:`text-xl text-gray-400`,children:`Select a video to start playing`})]})})]}),s&&!k&&(0,y.jsx)(x,{isVisible:T,onInteract:E,children:(0,y.jsx)(S,{videoPlayer:a,viewControls:o,currentVideo:s,onLock:()=>A(!0),onRecenter:()=>{ee.current&&ee.current.resetView()},invertStereo:C,toggleInvertStereo:()=>w(e=>!e)})})]})]})}var tl=el;(0,g.createRoot)(document.getElementById(`root`)).render((0,y.jsx)(_.StrictMode,{children:(0,y.jsx)(tl,{})}));